    ...
    <>
      <main className="page-wrapper">
        <div className="page-hero">
          ...
          <p>Expert guides on UAE end-of-service gratuity and labour law — updated for 2026.</p>
        </div>

        <div className="card">
          <div className="badge bg-teal">MUST READ</div>
          <h2>UAE Gratuity — Resignation vs Termination 2026</h2>
          <p>Does resigning affect how much gratuity you get? The 2022 law change that most employees do not know about. Full guide with worked examples and MOHRE rules.</p>

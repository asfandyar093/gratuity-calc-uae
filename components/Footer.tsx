  ...
  return (
    <footer className="site-footer">
      ...
      <div className="footer-desc">
        ...
        <span className="lang-ar" lang="ar">حاسبة مجانية لمكافأة نهاية الخدمة في الإمارات · تحديث 2026 · وفق المرسوم بقانون اتحادي رقم 33 لسنة 2021</span>
      </div>
      ...
      <div className="footer-links">
        ...
        <Link href="/gratuity-calculator/education">Teacher gratuity</Link>
        <Link href="/blog/uae-healthcare-workers-gratuity">Healthcare gratuity</Link>
